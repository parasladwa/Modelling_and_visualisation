...
def main():
    ...
    #absorbing state - all susceptible to infection (white)
    p1, p2, p3 = 0.1, 0.9, 0.9
    
    # dynamic equilibrium between S, I and R; 
    p1, p2, p3 = 0.7, 0.5, 0.5
    
    # case with cyclic wave of infections through the lattice.
    p1, p2, p3 = 0.8, 0.1, 0.1
